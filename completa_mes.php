...
?><div class="section-content"><h1 class="title-news"><? echo $row["titulo"];?></h1>
						  ...
						  ?>
                      <? echo $day . '-' . $month . '-' . $year;?> - <? echo $row["diario"];?> - <? echo $row["ciudad"];?> - <? echo $row["provincia"];?><span class="fa fa-circle"></span><? echo $row["aut_cuerpo"];?></span><a href="https://twitter.com/share" class="twitter-share-button" data-url="<?=trim($url_corta)?>" data-text="<?=$titulo?>" data-via="aguadiarios" data-lang="es" data-count="none">Twittear</a>
