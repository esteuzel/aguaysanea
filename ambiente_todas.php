...
mysql_connect("localhost","dario","benz");
	...
	$result=mysql_db_query("info_nueva","SELECT Count(*)-5 AS cuenta FROM dia WHERE rubro='medio ambiente';");
...
<a href="ambiente.php"><span class="title">Soy abonado</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="form_intro.php"><span class="title">Solicitar contrase&ntilde;a</span></a></div>
                                        <div class="row">
