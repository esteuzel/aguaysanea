...
?><div class="section-content"><h1 class="title-news"><a
						  ...
						  ?>
                      <? echo $day . '-' . $month . '-' . $year;?> - <? echo $row["diario"];?> - <? echo $row["ciudad"];?> - <? echo $row["provincia"];?></span><a href="https://twitter.com/share" class="twitter-share-button" data-url="<?=trim($url_corta)?>" data-text="<?=$titulo?>" data-via="aguadiarios" data-lang="es" data-count="none">Twittear</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script> <a href="https://twitter.com/aguadiarios" class="twitter-follow-button" data-show-count="false" data-lang="es">Seguir a @aguadiarios</a>
