            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-left col-sm-8">
                               <div id="hot-topics" class="section-category">
                                <div class="section-name"><? $codigo = isset($_POST["codigo"]) ? $_POST["codigo"]:"";?>
                                    <div class="pull-left"><a href="#">Usted filtr&oacute; Noticias del diario "<?=$codigo?>"</a></div>
						...
						$result=mysql_db_query("info_nueva","select * from dia WHERE diario='$codigo' and rubro='agua' ORDER by provorder ASC limit 0,50");
						...
						?><div class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="media-heading"><a href="#" class="title"><? echo '<a target="_blank" class="title" href=http://www.informesdiarios.com.ar/aguaysanea/technology_detail.php?codigo='.$row["Id"].'>';?><? echo ''.$row["titulo"].'';?></a></a></div>
