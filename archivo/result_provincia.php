...
<head><title>Informes Diarios | Agua y Saneamiento</title>
    ...
    <link type="text/css" rel="stylesheet" href="http://www.informesdiarios.com.ar/aguaysanea/assets/css/pages/sport.css">
</head>
            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-left col-sm-8">
                               <div id="hot-topics" class="section-category">
                                <div class="section-name"><? $codigo = isset($_POST["codigo"]) ? $_POST["codigo"]:"";?>
                                    <div class="pull-left"><a href="#">Usted filtr&oacute; Noticias de la provincia "<?=$codigo?>"</a></div>
						...
						$result=mysql_db_query("info_nueva","select * from dia WHERE provincia='$codigo' and rubro='agua' ORDER by provorder ASC limit 0,50");
...
?>
                        ...
                        <div class="col-md-4 col-right col-sm-4">
                            <div id="popular-topics" class="section-category3">
                                <div class="section-name">+ De agua</div>
                                <div class="section-content">
