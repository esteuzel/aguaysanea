                        ...
                        <div class="col-md-8 col-left col-sm-8">
                               <div id="hot-topics" class="section-category">
                                <div class="section-name"><? $codigo = isset($_GET["codigo"]) ? $_GET["codigo"]:"";?>
                                    <div class="pull-left">Todos las noticias de Agua y Saneamiento del <?=$codigo?> (<?
mysql_connect("localhost","dario","benz");
	...
	$result=mysql_db_query("info_nueva","SELECT Count(*) AS cuenta FROM mes WHERE fecha='$codigo' and rubro ='agua';");
...
$pegar = "SELECT * FROM mes WHERE fecha='$codigo' and rubro='agua' GROUP BY titulo ORDER BY provorder,diario ASC LIMIT $inicial,$cantidad";
$cad = mysql_db_query($base,$pegar) or die (mysql_error());

$contar = "SELECT * FROM mes WHERE fecha='$codigo' and rubro='agua'"; 
...
?><div class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="media-heading"><class="title"><? echo '<a target="_blank" class="title" href=http://www.informesdiarios.com.ar/agua/completa_mes.php?codigo='.$array["Id"].'>';?><? echo ''.$array["titulo"].'';?></a></div>
