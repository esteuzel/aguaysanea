                        ...
                        <div class="col-md-8 col-left col-sm-8">
                               <div id="hot-topics" class="section-category">
                                <div class="section-name">
                                    <div class="pull-left">Todas las noticias de Agua y Saneamiento de hoy (<?
mysql_connect("localhost","dario","benz");
	$base="info_nueva";
	$con=mysql_connect("localhost","dario","benz");
	mysql_select_db($base,$con);
	
	$result=mysql_db_query("info_nueva","SELECT Count(*) AS cuenta FROM dia WHERE rubro='agua' and provincia='buenos aires';");
...
?>) Ejemplo: Prov. de Buenos Aires, solicite la provincia de su inter&eacute;s</div>
...
$pegar = "SELECT * FROM dia WHERE rubro='agua' and provincia='buenos aires' GROUP BY titulo ORDER BY provorder,diario ASC LIMIT $inicial,$cantidad";
$cad = mysql_db_query($base,$pegar) or die (mysql_error());

$contar = "SELECT * FROM dia WHERE rubro='agua' and provincia='buenos aires'"; 
