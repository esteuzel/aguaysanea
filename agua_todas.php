...
$pegar = "SELECT * FROM dia WHERE rubro='agua' GROUP BY titulo ORDER BY rubro ASC LIMIT $inicial,$cantidad";
...
?><div class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="media-heading"><class="title"><? echo '<a target="_blank" class="title" href=http://www.informesdiarios.com.ar/aguaysanea/technology_free.php?codigo='.$array["Id"].'>';?><? echo ''.$array["titulo"].'';?></a></div>
...
?>
<b><font size="+2" color="#E50307"><div class="thumb3" align="center"><br>Hay <?
mysql_connect("localhost","dario","benz");
	$base="info_nueva";
	$con=mysql_connect("localhost","dario","benz");
	mysql_select_db($base,$con);
	
	$result=mysql_db_query("info_nueva","SELECT Count(*)-5 AS cuenta FROM dia WHERE rubro='agua';");
...
mysql_free_result($result)
?> noticias m&aacute;s de este rubro clasificadas hoy <?
						  $day = substr($fecha,8,2);
						  $month = substr($fecha,5,2);
						  $year = substr($fecha,0,4);
						  ?>
                  <? echo $day . '-' . $month . '-' . $year;?>, para acceder debe estar registrado</font></b><br><br>
<a href="titulos.php"><span class="title">Soy abonado</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="form_intro.php"><span class="title">Solicitar contrase&ntilde;a</span></a></div>
                                        <div class="row">
