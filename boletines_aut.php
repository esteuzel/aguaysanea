                        ...
                        <div class="col-md-8 col-left col-sm-8">
                               <div id="hot-topics" class="section-category">
                                <div class="section-name">
                                    <div class="pull-left">Boletines Enviados por<?
						mysql_connect("localhost","dario","benz");
						
						$codigo = isset($_GET["codigo"]) ? $_GET["codigo"]:"";
						
						$result=mysql_db_query("info_nueva","select * from notasinteres WHERE autor='$codigo' ORDER by fecha DESC limit 0,1");
...
?></div>
						...
						$result=mysql_db_query("info_nueva","select * from notasinteres WHERE autor='$codigo' ORDER by fecha DESC limit 0,50");
						...
						?><div class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="media-heading"><a href="#" class="title"><? echo '<a target="_blank" class="title" href=http://www.informesdiarios.com.ar/puertos/interes_completa.php?codigo='.$row["id"].'>';?><? echo ''.$row["titulo"].'';?></a></a></div>
                                                <div class="info"><span class="category"><? echo ''.$row["autor"].'';?> - </span></span><span class="date-created"><? echo ''.$row["rubro_bis"].'';?><span
...
?>
                        ...
                        <div class="col-md-4 col-right col-sm-4">
                            <div id="popular-topics" class="section-category3">
                                <div class="section-name">Gremiales</div>
                                <div class="section-content">
                                    <ul class="list-unstyled"><?
						mysql_connect("localhost","dario","benz");
						
						$result=mysql_db_query("info_nueva","select * from dia WHERE rubro='fcgt' or rubro='fdoc' or rubro='fest' ORDER by id DESC limit 0,12");
