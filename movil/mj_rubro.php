	  		...
	  		<div class="post">
		  		<div class="post-titulos">
		  			<?
						...
						$result=mysql_db_query("sintesis","select * from dia WHERE rubro='$rubro' ORDER BY provorder ASC");
						...
						?><?
						  ...
						  ?>
                        <? echo '<a class="post-titulos" a href=mj_full.php?codigo='.$row["Id"].'>';?> <? echo limpiar_caracteres_especiales (''.$row["titulo"].'');?><br />
