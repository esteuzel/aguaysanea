...
<div id="container">
		...
		<div id="menu">
	  	...
	  	<div id="contenido">
	  		<div class="post">
		  		<div class="post-titulos">Informaci&oacute;n clasificada de Boletines Oficiales<br /><br />	
		  			<?
						mysql_connect("localhost","dario","benz");
												
						$result=mysql_db_query("info_nueva","select * from mes WHERE nivel='9' and rubro='agua' ORDER BY Id DESC");
