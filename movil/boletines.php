	  		...
	  		<div class="post">
		  		<div class="post-titulos">
		  			<?
						...
						$result=mysql_db_query("info_nueva","select * from notasinteres WHERE rubro='Agua y Saneamiento' ORDER BY fecha DESC");
						...
						?><?
						  ...
						  ?>
                        <? echo '<a class="post-titulos" a href=full_int.php?codigo='.$row["id"].'>';?> <? echo limpiar_caracteres_especiales (''.$row["titulo"].'');?><br />
						<div class="post-diario"><? echo ''.$row["autor"].'';?> - <? echo $day . '-' . $month . '-' . $year;?></div><br />
                        <?
}
