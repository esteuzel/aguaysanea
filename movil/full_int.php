		  		...
		  		<div class="post-titulos">
		  			<?
						...
						?><?
						  ...
						  ?>
                         <? echo ''.$row["titulo"].'';?><br />
						<div class="post-diario"><? echo ''.$row["autor"].'';?> - <? echo $day . '-' . $month . '-' . $year;?></div><br /><div class="post-cuerpo"><? echo '<img src=http://www.informesdiarios.com.ar/interes/fotos/'.$row['foto'].' width=100% border=0>' ?><br /><br /><? echo ''.$row["cuerpo"].'';?></div>
                        <?
}
