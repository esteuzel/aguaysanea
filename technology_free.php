...
$result=mysql_db_query("info_nueva","select * from dia WHERE Id='$codigo'");

while ($row=mysql_fetch_array($result))
{
$fecha = $row["fecha"];
$result2=mysql_db_query("info_nueva","select diario,titulo,ciudad,provincia,rubro,foto FROM dia WHERE misma='".$row['misma']."' and hoy='hoy' and misma !=''");

?><html lang="en">
<head><title>Informes Diarios | Agricultura</title>
...
<meta property="og:title" content="<? echo $row["titulo"];?>" />
<meta property="og:url" content="" />
<meta property="og:image" content="http://www.informesdiarios.com.ar/paginas/fotos/<? echo $row["foto"];?>" />
</head><?
...
{
$fecha = $row["fecha"];
$result2=mysql_db_query("info_nueva","select diario,titulo,ciudad,provincia,rubro FROM dia WHERE misma='".$row['misma']."' and hoy='hoy' and misma !=''");

?><? 	$titulo= $row["titulo"]; //variable definidada para el uno en el include barra3, para pasar el titulo al twitter
						?><div class="section-content"><h1 class="title-news"><a
                                                href="technology_detail.html"><? echo $row["titulo"];?></a></h1>
						  ...
						  ?>
                      <? echo $day . '-' . $month . '-' . $year;?> - <? echo $row["diario"];?> - <? echo $row["ciudad"];?> - <? echo $row["provincia"];?></span> <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?=trim($url_corta)?>" data-text="<?=$titulo?>" data-via="diariosinfo	" data-lang="es" data-count="none">Twittear</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script> <a href="https://twitter.com/diariosinfo" class="twitter-follow-button" data-show-count="false" data-lang="es">Seguir a @aguadiarios</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>&nbsp;&nbsp;&nbsp;&nbsp;<? include("../user.php") ?>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="main-news">
                                                <div class="image-news pull-left mrxxl image-one"><? echo '<img src=/paginas/fotos/'.$row['foto'].' class="img-responsive" alt="Nota sin imagen">' ?>
...
?>
                        ...
                        <div class="col-md-4 col-right col-sm-4">
                            <div class="related-news section-category2">
                                <div class="section-name">Boletines...</div>
                                <div class="section-content">
                                    <div class="related-news-list"><?
						mysql_connect("localhost","dario","benz");
						
						$result=mysql_db_query("info_nueva","select * from notasinteres WHERE rubro='agua y saneamiento' ORDER by fecha DESC limit 0,5");
