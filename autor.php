<!DOCTYPE html>
<html lang="en">
<head><title>Informes Diarios | Estatales</title>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-left col-sm-8">
                            <div class="latest_articles section-category">
                                <div class="section-name"><a href="#">Consulta de noticias por periodista</a></div>
                                <div class="section-content">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="thumb3" align="center"><br><a href="#"><img src="archivo/assets/images/travel/download.gif" width="37" height="39" alt="" /></a><br><br><a href="#" class="title">Seleccione el periodista de su inter&eacute;s</a><br><br>

                                                <form target="_blank" action="http://www.informesdiarios.com.ar/aguaysanea/archivo/result_autor.php" method="post" name="fecha" id="diario"><div class="description"><?
			  $link = mysql_connect("localhost","dario","benz"); 
			  mysql_select_db("info_nueva", $link);
		?>
                  <select name="codigo" id="diario" class="marron">
                    <?
		$result = mysql_query("SELECT * FROM mes WHERE rubro='agua' and aut_cuerpo!='' GROUP BY aut_cuerpo ORDER BY aut_cuerpo ASC", $link); 
		while ($row=mysql_fetch_array($result)){
		?>
                    <option value="<? echo $row["aut_cuerpo"];?>"> <? echo $row["aut_cuerpo"];?> </option>
                    <?
		  }
		  ?>
                  </select>
